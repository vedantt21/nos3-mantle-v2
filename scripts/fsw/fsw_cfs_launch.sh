...
do
    ...
    gnome-terminal --tab --title=$SC_NUM" - TCS Sim"      -- $DFLAGS -v $SIM_DIR:$SIM_DIR --name $SC_NUM"-tcs-sim"      --network=$SC_NETNAME -w $SIM_BIN $DBOX ./nos3-single-simulator $SC_CFG_FILE tcs-sim
